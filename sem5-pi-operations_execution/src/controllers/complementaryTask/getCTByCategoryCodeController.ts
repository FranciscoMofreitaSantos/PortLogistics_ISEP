...
@Service()
export default class GetCTByCategoryCodeController extends BaseController {
    ...
    protected async executeImpl(): Promise<any> {
        this.logger.info("HTTP GET /api/complementary-tasks/categoryCode");
        ...
        try {
            ...
            const result = await this.ctService.getByCategoryCodeAsync(cat);
            ...
            this.logger.info("Successfully fetched by category code CTs. Sending HTTP 200 OK.");
            return this.ok(this.res, result.getValue());

        } catch (e) {

            if (e instanceof BusinessRuleValidationError) {
                this.logger.warn("Business rule violation on getByCategoryCode CT", {
                    message: e.message,
                    details: e.details
                });
            ...
            this.logger.error("Unhandled error in GetCTByCategoryCodeController", {
