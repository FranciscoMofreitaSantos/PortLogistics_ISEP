...
@Service()
export default class GetCTByVveController extends BaseController {
    ...
    protected async executeImpl(): Promise<any> {
        ...
        try {
            ...
            this.logger.info("Successfully fetched by vve CTs. Sending HTTP 200 OK.");
            return this.ok(this.res, result.getValue());

        } catch (e) {

            if (e instanceof BusinessRuleValidationError) {
                this.logger.warn("Business rule violation on getByVve CT", {
                    message: e.message,
                    details: e.details
                });
            ...
            this.logger.error("Unhandled error in GetCTByVveController", {
